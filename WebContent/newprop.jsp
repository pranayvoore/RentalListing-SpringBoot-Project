...
<body style="background-color: #cfd2c7">
		...
		<div class="container">
			...
			<div class="single-page-nav sticky-wrapper" id="tmNavbar">
				<ul class="nav navbar-nav">
					...
					<li><a
						href="${contextPath}/propByuser/${pageContext.request.userPrincipal.name}"">My
							Properties</a></li>
					<li>
						<div class="navbardd">
							<div class="dropdownd">
	...
	<br>
	<div align="center">
		<u><h2>Post A Property</h2></u> <br>

		<div>
			<div>
				<form:form
					action="${contextPath}/add/${pageContext.request.userPrincipal.name}?${_csrf.parameterName}=${_csrf.token}"
					modelAttribute="property" method="post"
